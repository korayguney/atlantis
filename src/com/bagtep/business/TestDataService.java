...
public class TestDataService {
	...
	public void createTestData() {
		...
		if (k == null) {
			...
			try {
				...
				// InputStream in =
				// getClass().getResourceAsStream("/com/bagtep/domain/testdata/matematik.txt");
				...
				// }
				// if (!line.contains("ÜNİTE") && !line.contains("Amaç ") &&
				// !line.contains("Davranışlar ")
				// && line.length() > 5) {
	...
	public GenelAmac getGenelAmac(int dersId, int genelAmacId) {
		// List<GenelAmac> genelAmaclar = entityManager.createQuery("select g
		// from GenelAmac g where
		// g.dersno=:dersno",Ders.class).setParameter("dersno",
		// dersno).getResultList();
...
//		System.out.println("GENEL AMAÇ 1 : " + genelAmaclar.get(1));
//		System.out.println("GENEL AMAÇ 2 : " + genelAmaclar.get(2));
//		System.out.println("GENEL AMAÇ 65 : " + genelAmaclar.get(65));
