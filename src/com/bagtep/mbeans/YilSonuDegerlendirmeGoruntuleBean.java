...
@ManagedBean
@ViewScoped
public class YilSonuDegerlendirmeGoruntuleBean {
	...
	public void init() {
		...
		yilSonuDegerlendirme = yilSonuDegerlendirmeService.yilSonuDegerlendirmeGetir(ogrenciId, dersId);
		List<YilSonuDegerlendirmeKazanimCevap> yilSonuDegerlendirmeKazanimCevap = yilSonuDegerlendirme.getYilSonuDegerlendirmeKazanimCevap();
		degerlendirmeTarihi = yilSonuDegerlendirme.getDegerlendirmeTarihi();
		...
		if(dersAd.equals("Matematik")){
			this.genelAmac = testDataService2.getGenelAmac(dersId, 1);
				for (OzelAmac o : this.genelAmac.getOzelAmaclar()) {
					this.ozelAmaclarMap.put(o.getId(), o.getYilSonuDegerlendirmeKazanimCevap().iterator().next().getYilSonuDegerlendirmeCevap());
				}
				
				for (OzelAmac o : this.genelAmac.getOzelAmaclar()) {
					this.ozelAmacYorum.put(o.getId(), o.getYilSonuDegerlendirmeKazanimCevap().iterator().next().getYorum());
				}
	...
	public void degerlendirmeGoruntuleKaydet() {
		...
		yilSonuDegerlendirmeService.degerlendirmeGoruntuleKaydet(ogrenciId, dersAd, degerlendirici, ozelAmaclarMap, ozelAmacYorum, ozelAmacIdMap);
		FacesContext.getCurrentInstance().addMessage(null,
