...
public class DersEkleBean {
	...
	public String add()
	{
		...
		addMessage(null,new FacesMessage(FacesMessage.SEVERITY_INFO, "","Yeni ders başarıyla eklendi!!"));
	 ...
	 public void deleteDers(int dersId) {
	        ...
	        this.dersler=dersService.getAllDers();
	        FacesContext.getCurrentInstance().
			addMessage(null,new FacesMessage(FacesMessage.SEVERITY_INFO, "","Ders başarıyla silindi!!"));
	    }
	 ...
	 public void onRowEdit(RowEditEvent event) {
        ...
        // DersService.updateUserWithEdit(Ders);
         FacesContext.getCurrentInstance().addMessage(null, 
        		 new FacesMessage(Ders.getDersAd()+" düzenlendi"));
    }
