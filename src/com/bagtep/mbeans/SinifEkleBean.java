...
public class SinifEkleBean {
	...
	public String add()
	{
		...
		addMessage(null,new FacesMessage(FacesMessage.SEVERITY_INFO, "","Yeni sınıf başarıyla eklendi!!"));
	 ...
	 public void deleteSinif(int sinifId) {
	       	...
	       	this.siniflar=sinifService.getAllSinif();
	        FacesContext.getCurrentInstance().
			addMessage(null,new FacesMessage(FacesMessage.SEVERITY_INFO, "","Sınıf başarıyla silindi!!"));
	    }
	 ...
	 public void onRowEdit(RowEditEvent event) {
        ...
        // DersService.updateUserWithEdit(Ders);
         FacesContext.getCurrentInstance().addMessage(null, 
        		 new FacesMessage(sinif.getSinifAd() +" düzenlendi"));
    }
