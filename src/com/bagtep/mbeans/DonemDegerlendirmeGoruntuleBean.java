...
@ManagedBean
@ViewScoped
public class DonemDegerlendirmeGoruntuleBean {
	...
	public void init() {
		...
		donemDegerlendirme = donemDegerlendirmeService.donemDegerlendirmeGetir(ogrenciId, dersId);
		List<DonemDegerlendirmeKazanimCevap> donemDegerlendirmeKazanimCevap = donemDegerlendirme.getDonemDegerlendirmeKazanimCevap();
		degerlendirmeTarihi = donemDegerlendirme.getDegerlendirmeTarihi();
		...
		if(dersAd.equals("Matematik")){
			this.genelAmac = testDataService2.getGenelAmac(dersId, 1);
				for (OzelAmac o : this.genelAmac.getOzelAmaclar()) {
					this.ozelAmaclarMap.put(o.getId(), o.getDonemDegerlendirmeKazanimCevap().iterator().next().getDonemDegerlendirmeCevap());
				}
				
				for (OzelAmac o : this.genelAmac.getOzelAmaclar()) {
					this.ozelAmacYorum.put(o.getId(), o.getDonemDegerlendirmeKazanimCevap().iterator().next().getYorum());
				}
